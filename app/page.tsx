  ...
  return (
    <section style={{ marginTop: "5rem" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative block bg-[#111] aspect-square rounded-lg overflow-hidden border border-gray-800 transition-all duration-300 hover:border-[#EBCB4B] hover:shadow-[0_0_30px_rgba(235,203,75,0.15)]"
            >
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full flex items-center justify-center transition-all duration-300 group-hover:bg-[#EBCB4B] group-hover:scale-110 group-hover:shadow-[0_0_20px_#EBCB4B]">
                <div className="w-0 h-0 border-t-10 border-t-transparent border-l-18 border-l-black border-b-10px border-b-transparent ml-1"></div>
              </div>
              <div className="absolute bottom-6 left-0 w-full px-6">
                <p className="font-bold text-white mb-1 text-left">
                  Marcus Reid
                </p>
                <p className="text-xs text-gray-400 text-left uppercase tracking-widest group-hover:text-[#EBCB4B]">
                  Founder, Strategy
                </p>
              </div>
            </a>
            ...
            >
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full flex items-center justify-center transition-all duration-300 group-hover:bg-[#EBCB4B] group-hover:scale-110 group-hover:shadow-[0_0_20px_#EBCB4B]">
                <div className="w-0 h-0 border-t-10 border-t-transparent border-l-18 border-l-black border-b-10 border-b-transparent ml-1"></div>
              </div>
              ...
              <div className="absolute bottom-6 left-0 w-full px-6">
                ...
                <p className="text-xs text-gray-400 text-left uppercase tracking-widest group-hover:text-[#EBCB4B] transition-colors">
                  Founder, Strategy
                </p>
              </div>
            </a>
      ...
      <div className="bg-[#111111] text-white py-24 px-8 text-center border-t border-gray-900">
        ...
        <p className="text-gray-400 mb-8 font-medium text-lg">
